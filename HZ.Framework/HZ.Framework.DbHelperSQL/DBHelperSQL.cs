...
namespace HZ.Framework.DbHelperSQL
{
            ...
            foreach (DataRow row in table.Rows)
            {
                ...
                foreach (PropertyInfo pro in propertypes)
                {
                    ...
                    if (table.Columns.Contains(tempName))
                    {
                        ...
                        {
                            if (value.GetType() == typeof(System.Double) && tempName.ToLower().Contains("price"))
                            {
                                decimal relValue = Convert.ToDecimal(value);
                                pro.SetValue(t, relValue, null);
                            }
                            else
